...
public class StartRequestDriver
{
    ...
    private OrderItem CreateOrderItemAndSetupProduct()
    {
    }

    private PostProcessPaymentRequest CreatePostProcessPaymentRequest()
    {
    ...
    public void SendStartRequest(string merchantKey = "TEST")
    {
        ...
        var startRequest = _simplePayStartRequest.CreateStartRequest();
        _simplePayStart.Send(startRequest).GetAwaiter().GetResult();
    }
